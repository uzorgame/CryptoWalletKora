...
import 'package:kora_windows/core/repositories/price_repository.dart' show PriceRepository, CryptoPrice;
  ...
  Future<List<Asset>> initializeTier1(String mnemonic) async {
    ...
    return [
      ...
      Asset(id: 'sol',      symbol: 'SOL',  name: 'Solana',
            ...
            iconUrl: coinIconUrl('sol'),  type: AssetType.native, isVisible: false),
      Asset(id: 'bnb',      symbol: 'BNB',  name: 'BNB',
            ...
            iconUrl: coinIconUrl('bnb'),  type: AssetType.native, isVisible: false),
      Asset(id: 'trx',      symbol: 'TRX',  name: 'Tron',
            ...
            iconUrl: coinIconUrl('trx'),  type: AssetType.native, isVisible: false),
      ...
      Asset(id: 'usdc_eth', symbol: 'USDC', name: 'USD Coin (Ethereum)',
            ...
            iconUrl: coinIconUrl('usdc'), type: AssetType.token,  isVisible: false),
    ];
  }
